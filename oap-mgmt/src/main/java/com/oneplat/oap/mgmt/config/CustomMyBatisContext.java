...
@MapperScan(annotationClass = Mapper.class, basePackages = "com.oneplat.oap", sqlSessionFactoryRef = "sqlSessionFactoryBean")
public class CustomMyBatisContext{
    ...
    public SqlSessionFactoryBean sqlSessionFactoryBean(DataSource dataSource, ApplicationContext applicationContext)
        ...
        factoryBean.setTypeAliasesPackage("com.oneplat.oap.core.mybatis.model");
        factoryBean.setTypeHandlersPackage("com.oneplat.oap.mgmt.common.mybatis.handler");
        return factoryBean;
    }
