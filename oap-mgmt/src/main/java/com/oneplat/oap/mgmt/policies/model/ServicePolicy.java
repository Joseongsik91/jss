 ...
 */
@ApiModel(description = "서비스 정책(policy) 모델")
@EqualsAndHashCode(callSuper = false)
@Data
public class ServicePolicy extends AbstractObject {
    ...
    @ApiModelProperty(value="그룹 이름", required = true, example = "", allowableValues="")
    @NotNull(message = "", groups = {ValidationUpdate.class})
