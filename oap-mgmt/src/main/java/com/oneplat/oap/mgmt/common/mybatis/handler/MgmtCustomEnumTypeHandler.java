 ...
 * 
 */
package com.oneplat.oap.mgmt.common.mybatis.handler;
...
import com.oneplat.oap.analytics.model.StatsIntervalType;
import com.oneplat.oap.core.annotation.DbValue;
import com.oneplat.oap.core.mybatis.enums.YesNoType;
import com.oneplat.oap.core.mybatis.handler.CustomEnumTypeHandler;
 ...
 *
 */
@MappedTypes({ YesNoType.class, OperatorGroup.class, OperatorCode.class, StatsIntervalType.class })
public class MgmtCustomEnumTypeHandler<E extends Enum<E>> extends CustomEnumTypeHandler<E> {

	private Class<E> type;
	private final E[] enums;
	private final Method invoker;

	public MgmtCustomEnumTypeHandler(Class<E> type) {
		super(type);
		this.type = type;
